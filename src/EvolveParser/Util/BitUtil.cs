...
// #define Toggle(data)   (data =~data )         /** Toggle Data value     **/
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint SetHighLowBitsUint(uint high, uint low) {
            return ((high << 16) | (low & 0xffff));
        }
        ...
        public static long IntsToLong(uint a1, uint a2) {
            long b = a2;
            b <<= 32;
            b |= a1;
            return b;
        ...
        public static void ULongToUInts(ulong longVal, out uint int0, out uint int1) {
            int0 = (uint) (longVal & uint.MaxValue);
            int1 = (uint) (longVal >> 32);
        }
        ...
        public static bool TrySetBit(ref ulong val, int bitIdx) {
        ...
        public static ulong SetBit(ulong val, int bitIdx) {
            return val | (1ul << bitIdx);
        }

        public static void SetBit(ref ulong val, int bitIdx) {
            val |= (1ul << bitIdx);
        }

        public static bool GetBit(ulong val, int bitIdx) {
            return (val & (1ul << bitIdx)) != 0;
        }
