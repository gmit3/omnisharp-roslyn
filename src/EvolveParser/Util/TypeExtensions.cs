...
namespace EvolveUI.Extensions {

    public static class TypeExtensions {

        public static string GetMethodSignature(this MethodInfo method) {
            return TypeNameGenerator.GetMethodSignature(method);
        }
        ...
        internal static MethodInfo GetMethodValidated(this Type type, string name, BindingFlags bindingAttr, Binder binder, Type[] types, ParameterModifier[] modifiers) {
            // todo -- do this better w/o allocating 
        ...
        private static bool MatchesArgumentTypes(this MethodInfo mi, Type[] argTypes) {
            ...
            for (int index = 0; index < parameters.Length; ++index) {
                if (!AreReferenceAssignable(parameters[index].ParameterType, argTypes[index])) {
                    return false;
                }
            }
